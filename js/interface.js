var minersAddr = '0x7aC53FB500A5caEB84F6BbfDaCC11dB8bB31942e';
var tokenAddr = '0xa2295A80795b8158e97F80a184f9E5ef1233B164';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " ATFLP in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + trx + " ATFLP first");
	} else {
